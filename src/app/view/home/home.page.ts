...
import { GiphService } from 'src/app/service/giph-service';
...
export class HomePage implements OnInit {
  ...
  constructor(private giphyService: GiphService, private router: Router) {}
  ...
  goToGifDetails(gif: any){
    this.router.navigate(['/giph-detail'], {state: {gif:gif}})
  }
